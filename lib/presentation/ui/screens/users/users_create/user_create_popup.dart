...
import 'package:betonchel_manager/presentation/ui/screens/users/shared/models/user_form_validation_error.dart';
import 'package:betonchel_manager/presentation/ui/screens/users/users_create/bloc/user_create_cubit.dart';
import 'package:betonchel_manager/presentation/ui/screens/users/users_create/dependencies/user_create_dependencies.dart';
...
class EmployeeCreatePopup extends StatelessWidget implements AutoRouteWrapper {
  ...
  @override
  Widget wrappedRoute(BuildContext context) => UserCreateDependencies(child: this);

  @override
  Widget build(BuildContext context) {
    final strings = context.strings;

    return BlocConsumer<UserCreateCubit, FormScreenState>(
      ...
      builder: (context, state) {
        ...
        final form = state.form as UserForm;

        final validationError =
            state is FormValidationFailedState ? state.validationError as UserFormValidationError : null;
        ...
        return AlertDialog(
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              PrimaryButton(
                onPressed: context.read<UserCreateCubit>().submitForm,
